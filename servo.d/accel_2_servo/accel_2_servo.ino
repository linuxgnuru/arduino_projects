...
Servo servoUD, servoLR;  // create servo object to control a servo
...
void setup()
{
    servoUD.attach(3);  // attaches the servo on pin 9 to the servo object
    servoLR.attach(4);  // attaches the servo on pin 9 to the servo object
...
//            y = map(y, -83, 41, 0, 180);     // scale it to use it with the servo (value between 0 and 180) 
            servoUD.write(int(ypr[1] * -180/M_PI)+90);
            servoLR.write(int(ypr[2] * 180/M_PI)+90);

//            lcd.setCursor(0, 0);
//            lcd.print("ypr: ");
//            lcd.setCursor(5, 0);          // 6789012345  
/*
