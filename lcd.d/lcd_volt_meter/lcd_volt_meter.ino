...
void checkLight()
{
  //long ldrNum = map(abs(analogRead(ldrPin) - 1023), 0, 1023, 0, 255);
  long ldrNum = map(analogRead(ldrPin), 0, 1023, 0, 255);
  //Serial.println(ldrNum);
  //lcd.setCursor(0, 0);
  //lcd.print(ldrNum);
  analogWrite(backlightPin, ldrNum);
}
