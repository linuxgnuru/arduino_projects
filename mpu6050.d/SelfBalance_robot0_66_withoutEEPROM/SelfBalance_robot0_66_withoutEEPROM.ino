...
// Define PID limits to match PWM max in reverse and foward
...
void return_pid(bool b)    //return values from eeprom
{
  ...
  {
    sent.concat("OP");
    dtostrf(bal_kp, 5, 3, charVal);
    sent.concat(charVal);
    sent.concat("OI");
    dtostrf(bal_ki, 5, 3, charVal);
    sent.concat(charVal);
    sent.concat("OD");
    dtostrf(bal_kd, 5, 3, charVal);
    sent.concat(charVal);
    sent.concat("e");
    // Serial.println(sent);
  }
  ...
  {
    sent.concat("OP");
    dtostrf(rot_kp, 5, 3, charVal);
    sent.concat(charVal);
    sent.concat("OI");
    dtostrf(rot_ki, 5, 3, charVal);
    sent.concat(charVal);
    sent.concat("OD");
    dtostrf(rot_kd, 5, 3, charVal);
    sent.concat(charVal);
    sent.concat("e");
    Serial.println(sent);
  }
