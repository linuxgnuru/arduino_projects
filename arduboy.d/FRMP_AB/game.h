...
void computer_play_hand()
{
    ...
    // FIXME
    // disp_state = (last_winner == PLAYER_C ? GAME_SHOW_COMPUTER_CARD_PLAYED : GAME_DETERMINE_ROUND_WINNER);
...
void stateShowPlayer1Hand()
{
    ...
    //print_number (100, 0, player_p_hand_size); // NOT ME
...
{
    print_progmem(17, 0, text_pick_card_to_play);
    //print_number (100, 0, player_c_hand_size); // NOT ME
